                ...
                {listing.isLoading || statusItem !== status ? (
                  ...
                  >
                    <svg
                      ...
                      className="mx-auto my-10 h-fit w-2/3"
                    >
                      <g clip-path="url(#clip0_2003_2)">
                        ...
                        <path
                          opacity="0.05"
                          d="M496 447.759C576.777 447.759 642.259 382.277 642.259 301.5C642.259 220.723 576.777 155.24 496 155.24C415.223 155.24 349.74 220.723 349.74 301.5C349.74 382.277 415.223 447.759 496 447.759Z"
                          fill="black"
                        />
                        <path
                        ...
                        />
                        <path
                          d="M213.851 482.997C213.851 482.997 212.095 499.678 211.217 500.555C210.339 501.433 212.095 503.189 211.217 505.823C210.339 508.457 209.461 511.968 211.217 512.846C212.973 513.724 201.56 590.982 201.56 590.982C201.56 590.982 173.466 627.854 184.88 685.797L188.391 744.618C188.391 744.618 215.607 746.374 215.607 736.717C215.607 736.717 213.851 725.304 213.851 720.036C213.851 714.769 218.241 714.769 215.607 712.135C212.973 709.501 212.973 707.745 212.973 707.745C212.973 707.745 217.363 704.234 216.485 703.356C215.607 702.478 224.386 640.145 224.386 640.145C224.386 640.145 234.043 630.488 234.043 625.221V619.953C234.043 619.953 238.433 608.54 238.433 607.662C238.433 606.784 262.137 553.231 262.137 553.231L271.794 591.86L282.329 647.169C282.329 647.169 287.597 697.21 298.132 716.525C298.132 716.525 316.568 779.735 316.568 777.979C316.568 776.224 347.295 771.834 346.417 763.933C345.54 756.031 327.981 645.413 327.981 645.413L332.371 481.241L213.851 482.997Z"
                          fill="#42424B"
                        />
                        <path
                        ...
                        />
                        <path
                          d="M295.905 252.337C316.287 252.337 332.81 235.814 332.81 215.432C332.81 195.051 316.287 178.528 295.905 178.528C275.523 178.528 259 195.051 259 215.432C259 235.814 275.523 252.337 295.905 252.337Z"
                          fill="#FFB8B8"
                        />
                        <path
                          d="M272.181 227.558C272.181 227.558 245.82 276.061 243.711 276.061C241.603 276.061 291.16 291.878 291.16 291.878C291.16 291.878 304.868 245.483 306.976 241.266L272.181 227.558Z"
                          fill="#FFB8B8"
                        />
                        <path
                        ...
                        />
                        <path
                          d="M297.253 277.562C297.253 277.562 264.77 284.586 270.038 328.482C275.305 372.378 284.962 416.274 284.962 416.274L317.446 487.386L320.957 500.555L344.661 494.41L327.103 392.57C327.103 392.57 320.957 283.708 313.056 280.196C308.073 278.072 302.656 277.169 297.253 277.562Z"
                          fill="#D0CDE1"
                        />
                        <path
                          opacity="0.1"
