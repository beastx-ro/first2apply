...
export default function HelpPage() {
  return (
    <div className="flex flex-col space-y-6 p-6 md:p-10">
      <h1 className="w-fit text-2xl font-medium tracking-wide">FAQs</h1>

      <Accordion
        type="single"
        collapsible
        className="w-full rounded-lg border px-6"
      >
        ...
        <AccordionItem value="item-5" className="py-2">
          ...
          <AccordionContent className="text-base font-light">
            The app will also send email notifications to your registered email.
            These will include a summary of the new jobs found since your last
            visit. You can apply to these jobs directly from the email by simply
            clicking the job link. Email notifications can be disabled in the{" "}
