        ...
        return (
          ...
          >
            <section className="flex">
              ...
              <div
                id="jobsList"
                className="h-[calc(100vh-180px)] w-1/2 space-y-3 overflow-y-scroll lg:w-2/5"
              >
              ...
              <div
                className="h-[calc(100vh-180px)] w-1/2 lg:w-3/5 overflow-y-scroll border-l-[1px] border-muted pl-2 lg:pl-4"
                ref={jobDescriptionRef}
              >
                {listing.isLoading || statusItem !== status ? (
                  <div className="animate-pulse space-y-4 lg:space-y-5">
                    <JobSummarySkeleton />
                    <JobDetailsSkeleton />
                  </div>
                ) : listing.jobs.length > 0 ? (
                  ...
                  <div className="flexitems-center justify-center space-y-4 lg:space-y-5">
                    {/* Light mode svg */}
                    <svg
                      width="798"
                      height="835"
